...
class HomeService extends BaseProjectService {
	...
	/**首页列表 */
	async getHomeList() {
		let fields = 'ACTIVITY_START_DAY,ACTIVITY_END_DAY,ACTIVITY_START,ACTIVITY_TITLE,ACTIVITY_CATE_NAME,ACTIVITY_JOIN_CNT,ACTIVITY_USER_LIST,ACTIVITY_OBJ.coverbig,ACTIVITY_OBJ.cover';
		let where = {
			ACTIVITY_STATUS: 1
		}
